...
<script type="text/javascript"
	src="../lib/common/lib/jquery/jquery-3.2.1.min.js"></script>
<script type="text/javascript"
	src="../lib/common/lib/jquery-ui-datepicker/jquery-ui.min.js"></script>
<script type="text/javascript"
	src="../lib/common/lib/searchHighlight/SearchHighlight.js"></script>
<script type="text/javascript"
	src="../lib/common/lib/jqtree/tree.jquery.js"></script>
<script type="text/javascript"
	src="../lib/common/lib/jqtree/jqTreeContextMenu.js"></script>
...
<script type="text/javascript"
	src="../lib/common/js/organization/app.js"></script>
<script type="text/javascript"
	src="../lib/common/js/sweetalert/sweetalert.min.js"></script>
...
<body>
	<section id="wrap"> <section class="wrap_layout">
	...
	</script> <section id="container"> <header class="sub_head">
	<h2>
		<i class="ico_tit sub05"></i> <span>관리자 패스워드 변경</span>
	</h2>
	</header>
	<div class="conts_inner">
		...
		<form name="MainForm" class="conts_inner__article__inner jumbo_box">
			...
			<div id="searchArea" class="conts_body">
				<div class="toptable">
					<table>
						<button class="btn_type bg_base" type="button" id="userSave"
				...
				<div class="depttable">
					<table>
						...
						<thead>
							<tr>
								<th>관리자 로그인 패스워드</th>
								<th><input type="password" name="pwd" id="pwd" value=""
									style="width: 100%; ime-mode: disabled;"></th>
								<th></th>
							</tr>
						</thead>
					</table>
		...
		<h2>
			<i class="ico_tit sub05"></i> <span>첨부파일/미수신 저장 기간 변경</span>
		</h2>
		</header>
		<form name="MainForm" class="conts_inner__article__inner jumbo_box">
			<input type="hidden" name="seqList" id="seqList" value="">
