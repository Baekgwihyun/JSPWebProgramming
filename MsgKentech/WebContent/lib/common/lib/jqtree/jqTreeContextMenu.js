(function ($) {
	...
	$.fn.jqTreeContextMenu = function (menuElement, callbacks) {
		...
		$el.bind('tree.contextmenu', function (event) {
			...
			if(type == 'Dept') {
                    $menuEl.children('.user').css('display','none');
                    $menuEl.children('.dept').css('display','block');
            } else if(type == 'User') {
                    $menuEl.children('.user').css('display','block');
                    $menuEl.children('.dept').css('display','none');
            }
