(function($){
	...
	$.fn.getChkKeywordList = function(keyword) {
		var list = [];
		this.each(function(){
			var chkbox = $(this).data('chkbox');
			if (chkbox) {
				list = chkbox._getChkKeywordList(keyword);
			}
		});
		return list;
	}
	...
	$.fn.getItemKeywordList = function(keyword) {
		var list = [];
		this.each(function(){
			var chkbox = $(this).data('chkbox');
			if (chkbox) {
				list = chkbox._getItemKeywordList(keyword);
			}
		});
		return list;
	}
	$.fn.getChkObjList = function() {
		var list = [];
		this.each(function(){
			var chkbox = $(this).data('chkbox');
			if (chkbox) {
				list = chkbox._getChkObjList();
			}
		});
		return list;
	}
...
Chkbox.prototype._initItems = function() {
...
Chkbox.prototype._getChkObjList = function() {
	var list = [];
	this._$chkboxArea.find('.chkItem:checked').each(function(){
		list.push($(this));
	});
...
Chkbox.prototype._getChkKeywordList = function(keyword) {
	var list = [];
	this._$chkboxArea.find('.chkItem:checked').each(function(){
		var obj = $(this).data('item');
		var val = obj[keyword];
...
Chkbox.prototype._getItemKeywordList = function(keyword) {
	var list = [];
	this._$chkboxArea.find('.chkItem').each(function(){
		var obj = $(this).data('item');
		var val = obj[keyword];
